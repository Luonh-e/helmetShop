      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-100 p-6 rounded-lg shadow-md">
          ...
          <div className="border-t border-gray-300 py-4">
            <div className="mb-8 flex font-bold justify-between text-sm">
              <span>Sản phẩm</span>
              <span>Tạm tính</span>
            </div>
            {cartItems.map((item) => (
              <div>
                <div className="my-8 flex justify-between text-sm mt-2 ">
                  <span>{item.name}</span>
                  <span>{formatPrice(item.price)}.000</span>
                </div>
              </div>
            ))}
            <div className="border-t font-bold border-gray-300 py-4 mt-4 flex justify-between text-sm">
              <span>Tổng</span>
              <span>{formatPrice(totalPrice)}.000 VNĐ</span>
            </div>
          </div>
